...
contract GovernorZKTest is Test {
    ...
    function setUp() public {
        ...
        // Set up board management (4 members including chairman?)
        ...
        // Mint tokens and delegate to enable voting power
        uint256 initialSupply = 1000 ether;
        // govToken.mint(chairman, initialSupply);
        // govToken.mint(member1, initialSupply);
        // govToken.mint(member2, initialSupply);
        // govToken.mint(member3, initialSupply);
        ...
        // govToken.delegate(member3);
         ...
         // Use deal() to give tokens to board members
    ...
    /// @dev Helper to create a general proposal with given ID
    ...
    function testCreateGeneralProposal() public {
        ...
        assertEq(proposal.proposalType, ProposalTypes.ProposalType.GENERAL);
    ...
    function testVotingFlow() public {
        ...
        assertEq(
            uint8(governor.state(PROPOSAL_ID_VOTE_FLOW)),
    ...
    function testProposalPassing() public {
        ...
        assertEq(
            uint8(governor.state(PROPOSAL_ID_PASS)),
    ...
    function testProposalFailing() public {
        ...
        assertEq(
            uint8(governor.state(PROPOSAL_ID_FAIL)),
    ...
    function testCancelProposal() public {
        ...
        assertEq(
            uint8(governor.state(PROPOSAL_ID_CANCEL)),
